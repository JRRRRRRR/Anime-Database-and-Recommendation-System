...
ratings = pd.read_csv('/Users/jrchen/flatiron-ds-course/Milestones/capstone/cleaningData/clean_rating.csv', index_col=0)
	...
	if form.is_submitted():
		...
		if analyzeField in continuous:
		    ...
		    try:
		        ...
		        print('no data here')
		    plt.savefig('/Users/jrchen/flatiron-ds-course/Milestones/capstone/python/static/dist_{}.png'.format(analyzeField))
		    plt.close()
		...
		if analyzeField in continuous:
		    ...
		    try:
		        ...
		        print('no data here')
		    plt.savefig('/Users/jrchen/flatiron-ds-course/Milestones/capstone/python/static/box_{}.png'.format(analyzeField))
		    plt.close()
